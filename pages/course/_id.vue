        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-jg">
              ...
              <b v-if="course.price === 0" class="c-yellow" style="font-size:24px;">免费</b>
              <b v-else class="c-yellow" style="font-size:24px;">￥{{ course.price }}</b>
            </section>
                  ...
                  <section class="mt20">
                    <div class="lh-menu-wrap">
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          <!-- 课程章节目录 -->
                          <li v-for="(chapter, index) in chapterList" :key="index" class="lh-menu-stair">
...
export default {
  ...
  methods: {
    ...
    // 收藏
    addCollect(id) {
      collectApi.addCollect(id).then(resp => {
        this.isCollect = true
    ...
    // 取消收藏
    removeCollect(id) {
      collectApi.removeById(id).then(resp => {
